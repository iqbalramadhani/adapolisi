                                ...
                                <table style="width: 100%;" role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <p class="text-mobile" style="text-align: right; margin-top: 5%; margin-right: -20px; font-size: 15px;"><a style="font-size: medium;" href="#" target="_blank" rel="noopener"><img class="img-sm" style="display: block; margin-left: auto; margin-right: auto;" src="https://staging.adapolisi.id/demo9/media/logos/ada-polisi.png" width="120" /> </a></p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                        ...
                                        <tr>
                                            <td class="col" style="padding: 0 8px;" align="center" width="100%">
                                                ...
                                                <p class="text-mode" style="font-family: 'Open Sans', sans-serif, Verdana; font-size: 15px; color: #4c4c4c; line-height: 18px; text-align: justify; ">
                                                    Untuk melakukan aktivasi akun pada aplikasi Ada Polisi, silahkan lengkapi data untuk email yang telah terdaftar dengan klik link berikut ini :
                                                </p>
                                                <br />

                                                <a href="{{env('APP_URL').'/activation/'. $data['activation_token'] }}" style="background-color: #2c294b; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none;">Aktivasi Akun</a>
                                                ...
                                                <p class="text-mode" style="font-family: 'Open Sans', sans-serif, Verdana; font-size: 15px; color: #4c4c4c; line-height: 18px; text-align: justify; ">
                                                    ...
                                                    Jika Anda memiliki pertanyaan ataupun kendala, silahkan hubungi tim kami di support@adapolisi.id 
                                                </p>
                                                <br />
                                                ...
                                                <p style="font-family: 'Open Sans', sans-serif, Verdana; font-size: 15px; color: #4c4c4c; line-height: 18px; text-align: right; ">
                                                    <a href="https://myarchery.id">Admin Ada Polisi</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </tbody>
